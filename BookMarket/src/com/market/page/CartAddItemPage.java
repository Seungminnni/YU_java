...
public class CartAddItemPage extends JPanel {
	...
	public CartAddItemPage(JPanel panel, Cart cart) {
		...
		if (booklist == null || booklist.size() == 0) {
		    JOptionPane.showMessageDialog(this, "도서 정보가 없습니다. book.txt 파일을 확인하세요.", "도서 로드 오류",
			    JOptionPane.WARNING_MESSAGE);
		    // Disable add button and show empty state
		    JLabel emptyLabel = new JLabel("도서 정보가 없습니다.");
		    emptyLabel.setFont(ft);
		    imagePanel.removeAll();
		    imagePanel.add(emptyLabel);
